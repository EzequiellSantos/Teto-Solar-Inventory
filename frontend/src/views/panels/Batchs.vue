<template>
    ...
    <div id="Brand">
            ...
            <article v-if="notFound == true">

                <svg xmlns="http://www.w3.org/2000/svg" id="panelCloudy" version="1.0" width="250px" height="250px" viewBox="0 0 1024.000000 1024.000000" preserveAspectRatio="xMidYMid meet">
                ...
                <h2 style="color:#D0D0D0;">Placas Não Encontradas :(</h2>
